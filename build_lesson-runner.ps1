...
$root = "runner"  # or "pod\publish", etc.

# Get the original directory
$originalDir = Get-Location

# Define the output file in the original directory
$outputFile = Join-Path $originalDir "lesson-02C-distributed-runner.md"

# Define the README path in the original directory
$readmePath = Join-Path $originalDir "README.md"
...
try {
    ...
    Write-Output "# Lesson 02C: Distributed Runner" | Add-Content -Path $outputFile
    Write-Output "" | Add-Content -Path $outputFile
