...
ROOT_DIR="pod/publish"
# Get the original directory
ORIGINAL_DIR=$(pwd)
# Define the output file in the original directory
output_file="$ORIGINAL_DIR/lesson-02C-distributed-publish.md"
# Define the README path in the original directory
README_PATH="$ORIGINAL_DIR/README_PUBLISH.md"
...
# Initialize output file, including README_PUBLISH.md if it exists
...
{
    echo '# Lesson 02C: Distributed Publish'
    echo ''
