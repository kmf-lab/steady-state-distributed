...
$outputFile = Join-Path $originalDir "lesson-02C-distributed-subscribe.md"

# Define the README path in the original directory
$readmePath = Join-Path $originalDir "README_SUBSCRIBE.md"
...
try {
    ...
    Write-Output "# Lesson 02C: Distributed Subscribe" | Add-Content -Path $outputFile
    Write-Output "" | Add-Content -Path $outputFile
